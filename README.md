...
This is a copy of the web-app for managing the monster ability decks in the board game [Gloomhaven](https://boardgamegeek.com/boardgame/174430/gloomhaven)

You can run it from the web directly on <https://afriscipio.github.io/gloomy/>.
Original here <https://github.com/johreh/gloomycompanion>

Thanks to johreh for making a very useful app
